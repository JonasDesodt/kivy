...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -I/home/jonas/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include -I/home/jonas/kivy/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/python-installs/playlist/arm64-v8a/include/python3.1" ],
  CPPINCLUDES => [  ],
  CXX => "/usr/bin/ccache /home/jonas/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target aarch64-linux-android21 -fomit-frame-pointer -march=armv8-a -fPIC",
